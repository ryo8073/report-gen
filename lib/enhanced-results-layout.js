    ...
    setupContentEditingListeners() {
        ...
        if (contentEditor) {
            contentEditor.addEventListener('input', (e) => {
                this.handleContentChange(e.target.value, 'edit');
            });
        ...
        if (splitEditor) {
            splitEditor.addEventListener('input', (e) => {
                this.handleContentChange(e.target.value, 'split');
            });
            
            splitEditor.addEventListener('scroll', (e) => {
