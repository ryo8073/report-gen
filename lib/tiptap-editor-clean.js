...
class TiptapEditorClean {
    ...
    async loadTiptapPackages() {
        ...
        try {
            ...
            const TiptapMarkdown = markdownModule.TiptapMarkdown || markdownModule.default?.TiptapMarkdown || markdownModule.default || markdownModule;
            ...
            if (!Editor || !StarterKit || !TiptapMarkdown) {
