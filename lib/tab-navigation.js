    ...
    initializeEditorTab() {
        ...
        try {
            if (!this.richTextEditor) {
                // Use EnhancedWYSIWYGEditor for Word-like WYSIWYG editing experience
            ...
            const setInitialContent = () => {
                if (this.contentState && this.richTextEditor) {
                    ...
                    if (editedContent.content) {
                        // Always convert to HTML for WYSIWYG editor
                        const htmlContent = this.convertMarkdownToEditableHTML(editedContent.content);
                        console.log('[TabNavigation] Setting edited content in editor (HTML length:', htmlContent.length, ')');
                        ...
                        if (originalContent.content) {
                            ...
                            console.log('[TabNavigation] Setting original content in editor (HTML length:', htmlContent.length, ')');
                            this.safeSetContent(this.richTextEditor, htmlContent, 'EnhancedWYSIWYGEditor');
                        }
                    }
                }
