...
class AccessibilityManager {
    ...
    /**
     * Set up focus restoration functionality
     */
    setupFocusRestoration() {
        // Store the last focused element before page navigation
        window.addEventListener('beforeunload', () => {
            if (document.activeElement && document.activeElement !== document.body) {
                const selector = this.getElementSelector(document.activeElement);
                if (selector) {
                    localStorage.setItem('accessibility-last-focus', selector);
                }
            }
        });
        ...
        window.addEventListener('load', () => {
            const lastFocusSelector = localStorage.getItem('accessibility-last-focus');
        ...
        // Set up focus restoration for modal dialogs
        this.on('modalOpen', (data) => {
            this.lastFocusBeforeModal = document.activeElement;
        });
        
        this.on('modalClose', (data) => {
            if (this.lastFocusBeforeModal && this.isFocusable(this.lastFocusBeforeModal)) {
                setTimeout(() => {
        ...
        console.log('Focus restoration initialized');
    }
